...
### Código Completo
[Clique aqui para acessar o código](#customer-churn-analysis/customer-churn-analysis-code.py)

### Documentação e Insights
Confira a [documentação completa do Projeto 2](#customer-churn-analysis/README.md).
...
### Código Completo
[Clique aqui para acessar o código](#credit-scoring-prediction/credit-scoring-prediction-code.py)

### Documentação e Insights
Confira a [documentação completa do Projeto 3](#credit-scoring-prediction/README.md).
